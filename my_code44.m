...
%% 写出入螺线和出螺线与圆形边界的交点角度/交点处的切线斜率等几何信息
 [theta_min_1,theta_min_2,theta_max_2,rC1,rC2,x_C1,y_C1,x_C2,y_C2] = Cross_K(R,k);
...
function [LJ,k,L1,D1,L2,D2,v0]  = Init()
%% 初始化函数
    LJ=1.7; % 螺距
...
function [theta_min_1,theta_min_2,theta_max_2,rC1,rC2,x_C1,y_C1,x_C2,y_C2] = Cross_K(R,k)
